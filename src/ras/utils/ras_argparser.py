...
def parse_args():
    ...
    parser.add_argument("--metric", type=str, default="std", choices=["std", "l2norm", "attention_avg"], help="Metric to calculate the patch selection, currently support std and l2norm")
